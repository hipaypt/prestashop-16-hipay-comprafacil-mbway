 ...
 * @since 1.5.0
 */
require_once(_PS_MODULE_DIR_ . 'hipaymbway/mbway-sdk/lib/HipayMbway/MbwayClient.php');
require_once(_PS_MODULE_DIR_ . 'hipaymbway/mbway-sdk/lib/HipayMbway/MbwayRequest.php');
require_once(_PS_MODULE_DIR_ . 'hipaymbway/mbway-sdk/lib/HipayMbway/MbwayRequestTransaction.php');
require_once(_PS_MODULE_DIR_ . 'hipaymbway/mbway-sdk/lib/HipayMbway/MbwayRequestDetails.php');
require_once(_PS_MODULE_DIR_ . 'hipaymbway/mbway-sdk/lib/HipayMbway/MbwayRequestResponse.php');
require_once(_PS_MODULE_DIR_ . 'hipaymbway/mbway-sdk/lib/HipayMbway/MbwayRequestDetailsResponse.php');
require_once(_PS_MODULE_DIR_ . 'hipaymbway/mbway-sdk/lib/HipayMbway/MbwayRequestTransactionResponse.php');
require_once(_PS_MODULE_DIR_ . 'hipaymbway/mbway-sdk/lib/HipayMbway/MbwayPaymentDetailsResult.php');
require_once(_PS_MODULE_DIR_ . 'hipaymbway/mbway-sdk/lib/HipayMbway/MbwayRequestRefund.php');
require_once(_PS_MODULE_DIR_ . 'hipaymbway/mbway-sdk/lib/HipayMbway/MbwayNotification.php');
...
class HipayMbwayValidationModuleFrontController extends ModuleFrontController {
    ...
    public function postProcess() {
        ...
        $this->module->validateOrder((int) $cart->id, Configuration::get('HIPAY_MBWAY_CANCELLED'), $total, $this->module->displayName, NULL, $mailVars, (int) $currency->id, false, $customer->secure_key);
